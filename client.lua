...
local function salvareg()
    ...
    ESX.ShowNotification(Config.Lang[Config.Locale].savClip, Config.Notify.success)
end
...
local function elireg() 
    ...
    ESX.ShowNotification(Config.Lang[Config.Locale].delClip, Config.Notify.success)
end
